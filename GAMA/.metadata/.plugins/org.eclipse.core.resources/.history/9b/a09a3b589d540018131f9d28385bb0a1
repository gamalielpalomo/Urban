...
global torus:false{
	...
	init{
		...
		create people number:numAgents{
			...
			location <- {rnd(worldDimension),rnd(worldDimension)} ;
...
experiment simulation type:gui{
	parameter "perception" var: distanceForInteraction <- 15#m category:"Globals";
	parameter "speed" var:agentsSpeed <- 1.0 category:"Agents";
	parameter "size" var:agentsSize <- 1 category:"Agents";
	output{
		display chart {
